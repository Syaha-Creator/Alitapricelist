...
/// Massindo Group brand color palette — copied verbatim from the legacy app
/// (`alitapricelist copy/lib/core/theme/app_colors.dart`) so this rewrite's
/// UI looks identical, not just structurally similar (per user's explicit
/// request to replicate the legacy visual design, not invent a new one).
class AppColors {
  AppColors._();
